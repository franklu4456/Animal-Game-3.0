...
namespace AnimalGame
{
    class Player
    {
        //variables store the information of the player
        private int _row;
        private int _column;
        private GameState _inBattle;
        private int _money;
        ...
        //gets if the player is in battle
        //sets if the player is in battle
        public GameState InBattle
        {
            get
            {
                return _inBattle;
