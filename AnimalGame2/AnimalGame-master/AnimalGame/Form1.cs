        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (pnlStore.Visible == true)
            {
                ...
                if (e.KeyCode == Keys.D1)
                {
                    ...
                    if (worldStore.PurchasedItem == true)
                    {
                        lblPurchasedItem.Text = temp.ToString() + " was purchased";
                    }
                    else
                    {
                        lblPurchasedItem.Text = "Player doesn't have enough money to purchase " + temp.ToString();
                    }
                }
